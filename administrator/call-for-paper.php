                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <textarea class="form-control" id="editor" name="call_content" style="height: 200px;"><?= $callpapers->view_callpapers(1)->call_papers?> </textarea> <!-- end Snow-editor-->
                            <input type="hidden" value="1" name="call_id">
